...
export class AlchemistV2Proxy extends ethereum.SmartContract {
  static bind(address: Address): AlchemistV2Proxy {
    return new AlchemistV2Proxy("AlchemistV2Proxy", address);
  }
